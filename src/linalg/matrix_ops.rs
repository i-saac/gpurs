...
impl Matrix<f32> {
    ...
    /// let ew_product: Matrix<f32> = matrix_1.elementwise_multiply(matrix_2)?;
    /// 
    /// assert_eq!(ew_product.get_data(), [2.0, 6.0, 12.0, 4.0]);
    /// # Ok(())
    /// # }
    /// ```
    pub fn elementwise_multiply(self, rhs: Matrix<f32>) -> Result<Matrix<f32>> {
    ...
    /// Sum Product (Dot Product) between two matrices.
    /// Matrices must be of the same size and shape.
    pub fn sumproduct(self, rhs: Matrix<f32>) -> Result<f32> {
...
impl Matrix<f64> {
    ...
    /// let ew_product: Matrix<f64> = matrix_1.elementwise_multiply(matrix_2)?;
    /// 
    /// assert_eq!(ew_product.get_data(), [2.0, 6.0, 12.0, 4.0]);
    /// # Ok(())
    /// # }
    /// ```
    pub fn elementwise_multiply(self, rhs: Matrix<f64>) -> Result<Matrix<f64>> {
        if self.get_rows() != rhs.get_rows() || self.get_cols() != rhs.get_cols() {
            return Err(Jeeperr::DimensionError)
        }
    ...
    /// Sum Product (Dot Product) between two matrices.
    /// Matrices must be of the same size and shape.
    pub fn sumproduct(self, rhs: Matrix<f64>) -> Result<f64> {
        if self.get_elements() != rhs.get_elements() {
            return Err(Jeeperr::DimensionError)
        }
